...
using CombatReports.OrdersExamples.TableExamples.TypeB3;
...
namespace CombatReports.TableOrders.TypeB3
{
    public partial class Order3_3 : Window
    {
        private readonly IOrderService orderService;
        private readonly UserProfile userProfile;

        public Order3_3(IOrderService orderService, UserProfile userProfile)
        {
            InitializeComponent();
        ...
        {
            Order3_3_Example form3_3_Example = new Order3_3_Example();
        ...
        private void GenerateDocumentButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                objDoc.SaveAs($"{Constant.RootToSaveGenerated}Form 3_3 {Constant.Date}");
                ...
                var order = orderService.AddOrder(path, userProfile.UserId, Constant.Form33);
                if (order != null)
                {

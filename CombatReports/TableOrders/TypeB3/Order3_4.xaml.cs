...
{
    public partial class Order3_4 : Window
    {
        private readonly IOrderService orderService;
        private readonly UserProfile userProfile;

        public Order3_4(IOrderService orderService, UserProfile userProfile)
        {
            InitializeComponent();
        ...
        {
            Order3_4_Example form3_4_Example = new Order3_4_Example();
        ...
        private void GenerateDocumentButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                var order = orderService.AddOrder(path, userProfile.UserId, Constant.Form34);
                if (order != null)
                {
